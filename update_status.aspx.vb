...
Partial Public Class UpdateStatus
    ...
    Protected Sub Form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles form1.Load
        ...
        lblStudy.Text = Project
        lblOld.Text = OldValue
        lblRegBody.Text = Regbody
    End Sub
    ...
    Protected Sub BtnChange_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnChange.Click
        ...
        strSQL = "update projectbodies set expirystatus ='" & ddlNewStatus.SelectedValue & "' where project = '" & Project & "'" & " and regbody = '" & Regbody & "'"
